...
from . import bulk_views, share_views, views, product_views, value_views
...
urlpatterns = [
    ...
    path('price/<int:pk>/confirm-current/', views.confirm_price_still_accurate, name='confirm_price_still_accurate'),
